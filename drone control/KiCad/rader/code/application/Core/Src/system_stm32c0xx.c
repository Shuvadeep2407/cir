...
#include "stm32c0xx.h"
#include "bootloader_api.h" // Include for APPLICATION_BASE definition
...
/* This application is loaded by a bootloader. The vector table is not at the start of FLASH. */
/* APPLICATION_BASE should be defined in your project settings (e.g., bootloader_api.h or compiler defines) */
#define VECT_TAB_OFFSET  APPLICATION_BASE /*!< Vector Table base offset field.
